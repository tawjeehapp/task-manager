...
async function main() {
  ...
  await upsertRows(admin, "projects", [
    {
      ...
      priority: "high",
      start_date: daysAgo4,
      end_date: shiftOrgDate(today, 60),
      created_by: adminId,
      updated_at: new Date().toISOString(),
    },
    {
      ...
      priority: "medium",
      start_date: null,
      end_date: shiftOrgDate(today, 90),
    ...
    },
    {
      ...
      priority: "medium",
      start_date: daysAgo3,
      end_date: shiftOrgDate(today, 45),
  ...
  await upsertRows(admin, "tasks", [
    ...
    },
    {
      ...
      project_id: IDS.projectPlatform,
      title: "مهمة مع المعيّن الافتراضي",
      description: "مسندة إلى المنشئ",
      status: "todo",
      priority: "low",
      assigned_to: users["1001"],
      created_by: users["1001"],
      estimated_hours: 1,
      progress_percentage: 0,
      completed_at: null,
